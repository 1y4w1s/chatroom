﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿﻿<template>
  <div class="chat-container">
      ...
      <div class="sidebar-content">
        <div v-show="sidebarTab === 'rooms'" class="room-list">
          <div class="room-list-header">
            <span class="room-list-title">对话列表</span>
    ...
    <main class="chat-main">
      <div v-if="selectedPost || currentRoomId || currentPrivateChatId" class="main-tabs">
         <button class="main-tab" :class="{ active: activeMainTab === 'chat' }" @click="switchToChat" v-if="currentRoomId || currentPrivateChatId">
          聊天室
        </button>
        ...
        <footer class="chat-input-footer">
          ...
          <div class="cc-card" v-else>
            <div v-if="replyTarget" class="reply-bar">
              <svg class="reply-bar-arrow" width="10" height="10" viewBox="0 0 10 10" fill="none">
              ...
              <span class="reply-bar-label">{{ replyTarget.sender }}</span>
              <span class="reply-bar-divider">|</span>
...
const openPrivateChat = async (friendId) => {
  ...
  try {
    ...
    privateMessages.value = (msgRes.data.messages || []).map(parseReplyContent)
    // 清除当前群聊
...
const sendPrivateMessage = async () => {
  ...
  if (replyTarget.value) {
    content = JSON.stringify({ text: content, replyTo: replyTarget.value })
...
const setupSocketListeners = () => {
  ...
  socket.on('new_private_chat', () => {
    loadPrivateChats()
  })

  socket.on('new_private_message', async (message) => {
    if (message.chat_id === currentPrivateChatId.value) {
      privateMessages.value.push(parseReplyContent(message))
      nextTick(() => scrollToBottom(true))
      await roomAPI.markPrivateChatRead(message.chat_id, authStore.userId)
    } else {
      const idx = privateChats.value.findIndex(c => c.id === message.chat_id)
      if (idx !== -1) {
        privateChats.value[idx] = {
          ...privateChats.value[idx],
          unread_count: (Number(privateChats.value[idx].unread_count) || 0) + 1
        }
      }
    }
    loadPrivateChats()
